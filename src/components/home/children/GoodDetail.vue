        ...
        <div class="wrapper">
          <div class="slider-wrapper">
            <slider class="slider" :loop="true" :autoPlay="true" v-if="topImages.length" :data="topImages">
              <a href="" v-for="item in topImages" :key='item'>
                <img :src="item" alt="">
              </a>
            </slider>
          </div>
          <div class="base-info">
            ...
            <div class="columns">
              <span v-for="column in dataInfo.columns" :key="column">{{column}}</span>
            </div>
            <div class="services">
              <div class="services-item" v-for="item in dataInfo.services" v-if="item.icon" :key="item">
